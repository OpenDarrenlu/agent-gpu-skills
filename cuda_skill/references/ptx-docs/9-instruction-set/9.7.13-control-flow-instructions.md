...
####  9.7.13.1. [Control Flow Instructions: `{}`](#control-flow-instructions-curly-braces)
...
####  9.7.13.2. [Control Flow Instructions: `@`](#control-flow-instructions-at)
...
####  9.7.13.3. [Control Flow Instructions: `bra`](#control-flow-instructions-bra)
...
####  9.7.13.4. [Control Flow Instructions: `brx.idx`](#control-flow-instructions-brx-idx)
...
####  9.7.13.5. [Control Flow Instructions: `call`](#control-flow-instructions-call)
...
####  9.7.13.6. [Control Flow Instructions: `ret`](#control-flow-instructions-ret)
...
####  9.7.13.7. [Control Flow Instructions: `exit`](#control-flow-instructions-exit)
