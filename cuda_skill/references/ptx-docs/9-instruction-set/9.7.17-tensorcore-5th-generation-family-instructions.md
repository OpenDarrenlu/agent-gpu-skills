...
####  9.7.17.1. [Tensor Memory](#tensor-memory)
...
####  9.7.17.2. [Matrix and Data Movement Shape](#tcgen05-matrix-data-movement-shape)
...
####  9.7.17.3. [Major-ness supported by Strides](#tcgen05-majorness-supported-by-strides)
...
####  9.7.17.4. [Matrix Descriptors](#tcgen05-matrix-descriptors)
...
####  9.7.17.5. [Issue Granularity](#tcgen05-issue-granularity)
...
####  9.7.17.6. [Memory Consistency Model for 5th generation of TensorCore operations](#tcgen05-memory-consistency-model)
...
####  9.7.17.7. [Tensor Memory Allocation and Management Instructions](#tcgen05-memory-alloc-manage-instructions)
...
####  9.7.17.8. [Tensor Memory and Register Load/Store Instructions](#tcgen05-tensor-memory-ld-st)
...
####  9.7.17.9. [Tensor Memory Data Movement Instructions](#tcgen05-data-movement-instructions)
...
####  9.7.17.10. [TensorCore 5th Generation Matrix Multiply and accumulate Operations](#tcgen05-mma)
...
####  9.7.17.11. [TensorCore 5th Generation Specialized Synchronization Operations](#tcgen05-special-sync-operations)
...
####  9.7.17.12. [TensorCore 5th Generation Async Synchronization Operations](#tcgen-async-sync-operations)
