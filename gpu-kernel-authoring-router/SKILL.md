...
description: >
  ...
  Triton, Gluon, CUTLASS, CuTe, CuTeDSL, DeepGEMM, grouped GEMM, MoE GEMM,
  GEMM, attention kernels, reductions,
  ...
  写 Triton、写 CUTLASS、写 DeepGEMM、写 grouped GEMM、写 GEMM、写 attention kernel、
  算子实现、CUDA/Triton/CUTLASS 选型。
---
