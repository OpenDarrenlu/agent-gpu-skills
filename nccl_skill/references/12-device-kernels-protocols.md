...
- `repos/nccl/src/device/common_kernel.h`: kernel execution framework and `RunWork*` dispatch.
- `repos/nccl/src/device/primitives.h`: high-level protocol primitive abstraction.
- `repos/nccl/src/device/prims_simple.h`: SIMPLE protocol primitives.
- `repos/nccl/src/device/prims_ll.h`: LL protocol primitives.
- `repos/nccl/src/device/prims_ll128.h`: LL128 protocol primitives.
- `repos/nccl/src/device/all_reduce.h`
- `repos/nccl/src/device/broadcast.h`
- `repos/nccl/src/device/reduce.h`
- `repos/nccl/src/device/reduce_scatter.h`
- `repos/nccl/src/device/all_gather.h`
- `repos/nccl/src/device/all_gather_v.h`
- `repos/nccl/src/device/sendrecv.h`
- `repos/nccl/src/device/reduce_kernel.h`
- `repos/nccl/src/device/generate.py`: generated kernel/header support.
- `repos/nccl/src/include/device.h`: device-side structures and constants.
