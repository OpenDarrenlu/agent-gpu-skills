...
- `repos/nccl/src/group.cc`: group nesting, async jobs, launch grouping.
- `repos/nccl/src/include/group.h`: group helper declarations/inlines.
- `repos/nccl/src/enqueue.cc`: central task and launch pipeline.
- `repos/nccl/src/include/enqueue.h`: launch phases and planner helpers.
- `repos/nccl/src/include/info.h`: `ncclInfo` API-call descriptor.
- `repos/nccl/src/include/comm.h`: task/planner/plan structures.
- `repos/nccl/src/scheduler/symmetric_sched.cc`: symmetric collective scheduler.
- `repos/nccl/src/scheduler/allgatherv_sched.cc`: allgatherv scheduler.
- `repos/nccl/src/include/scheduler.h`: scheduler extension declarations.
