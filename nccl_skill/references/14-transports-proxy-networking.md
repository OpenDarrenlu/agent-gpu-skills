...
- `repos/nccl/src/transport.cc`: transport multiplexer and P2P setup.
- `repos/nccl/src/include/transport.h`: transport interface structures.
- `repos/nccl/src/transport/p2p.cc`: CUDA P2P/direct GPU transport.
- `repos/nccl/src/transport/shm.cc`: shared-memory transport.
- `repos/nccl/src/transport/net.cc`: generic network transport layer.
- `repos/nccl/src/transport/net_socket.cc`: socket network implementation.
- `repos/nccl/src/transport/net_ib/*`: InfiniBand Verbs/RDMA implementation.
- `repos/nccl/src/transport/coll_net.cc`: CollNet transport.
- `repos/nccl/src/transport/nvls.cc`: NVLS transport.
- `repos/nccl/src/proxy.cc`: CPU proxy progress engine.
- `repos/nccl/src/include/proxy.h`: proxy structures/messages.
- `repos/nccl/src/plugin/net.cc`: external net plugin loading.
- `repos/nccl/plugins/net/README.md`: net plugin API.
