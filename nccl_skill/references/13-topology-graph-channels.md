...
- `repos/nccl/src/graph/topo.cc`: topology system construction.
- `repos/nccl/src/graph/topo.h`: topology declarations.
- `repos/nccl/src/graph/xml.cc`, `xml.h`: XML topology representation.
- `repos/nccl/src/graph/paths.cc`: path computation and trimming.
- `repos/nccl/src/graph/search.cc`: graph search for rings, trees, NVLS, CollNet, etc.
- `repos/nccl/src/graph/connect.cc`: convert selected graphs into channel connectivity.
- `repos/nccl/src/graph/rings.cc`, `rings.h`: ring helpers.
- `repos/nccl/src/graph/trees.cc`: tree helpers.
- `repos/nccl/src/graph/tuning.cc`: performance model and algorithm/protocol costs.
- `repos/nccl/src/include/graph.h`: internal graph declarations.
