...
**原文链接**: https://zhuanlan.zhihu.com/p/1917147937265423211

---

分享一下个人网页版本，好像排版更好一点: https://zyksir.github.io/2025/06/06/sglang-dp-attention/
...
本文重点看Sglang里dp attention这个概念，试图回答以下问题: 什么是 dp attention，为什么dp attention能带来性能提升，未来有什么演进的方向。欢迎大家多多交流。 在正式介绍之前，引用SGLang v0.4 blog里的一张图，介绍一些代码里的一些参数以及与之对应的概念。
...
Scatter的含义是，变量被切分成了tp 份，已经不能再切了
...
下面是实验代码，感兴趣(有机器)的小伙伴可以自行实验；跑的时候踩了一下坑，这是Sglang的相关PR：https://github.com/sgl-project/sglang/pull/7169
