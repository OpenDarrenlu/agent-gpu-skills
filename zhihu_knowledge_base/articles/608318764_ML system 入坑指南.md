...
**原文链接**: https://zhuanlan.zhihu.com/p/608318764

---

Blog 链接(ML system 入坑指南)

ML system 入坑指南

最近ChatGpt大火,越来越多的人开始关注大模型,但对于大模型落地而言,除了先进的算法,其背后的MLsystem(机器学习系统), 从分布式训练到高效推理的完整链路同样重要, 好的基础设施是应用爆发的基础.
