...
**原文链接**: https://zhuanlan.zhihu.com/p/1898141047164507218

---

引言

从deepseek大火到现在也已经有段时间了，笔者在三月份的时候也为了研究deepseek开源的专为MoE设计的通信库deepEP搞得焦头烂额过一段时间，当时也在各个网上搜过nvshmem对应的源码解析，感觉缺少一篇和deepEP关系紧密的nvshmem介绍的文章。笔者也是终于抽出时间，理了一下自己这一个多月来对于nvshmem的理解，顺便也留了点坑希望有懂行的朋友可以解答，如有错误，请大家见谅！
